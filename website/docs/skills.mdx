...
- **Home scope**: `~/.noumen/skills/`, `~/.claude/skills/`
- **Project scope**: every ancestor from the filesystem root down to `cwd`, e.g. `<dir>/.noumen/skills/`, `<dir>/.claude/skills/`
...
Narrow or rename the set of directories scanned via [`dotDirs`](/docs/context#dot-directories):

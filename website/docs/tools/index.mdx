...
description: noumen ships with six coding tools that cover file operations, shell commands, and codebase search — all sandboxed through VirtualFs and VirtualComputer.
---

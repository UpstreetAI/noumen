...
<Steps>
  ...
  <Step>
    ...
    For remote isolation or different environments, swap in `SpritesSandbox` (remote containers), `DockerSandbox`, `E2BSandbox`, or `FreestyleSandbox` (cloud VMs). See [Virtual Infrastructure](/docs/virtual).
  </Step>

...
<Steps>
  ...
  <Step>
    ...
    For remote isolation or different environments, swap in `SpritesSandbox` (remote containers), `DockerSandbox`, or `E2BSandbox`. See [Virtual Infrastructure](/docs/virtual).
  </Step>

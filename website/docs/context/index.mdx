...
2. Enable project context loading in your `Code` options:
...
You can use the loader and formatter independently of `Code`, for example to build your own prompt pipeline:
